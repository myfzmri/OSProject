...
1. What is the permission of folder /usr/local/apache/htdocs and what user and group owns the folder? . ***(2 mark)*** <img src="q1.jpg" width="70%"> __User = codespace, Group = codespace__.
